...
import { Eye, EyeOff, Info, KeyRound, Mail } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <button
        ...
        className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-border/80 bg-accent/30 px-3 py-1.5 text-sm font-medium text-foreground hover:bg-accent/60"
      >
