...
- [x] Write the business rules for each entity into a reference document ([`docs/domain/DOMAIN_RULES.md`](../domain/DOMAIN_RULES.md))
...
_More docs: [Documentation index](../README.md) · [v1.5 plan](../roadmap/ROADMAP.md) · [LifeOS README](../README.md)_
